...
---
# Terminology of `r Citet(biblio,"diegert_al2025")`
...
- `r Citet(biblio,"krauth2016")`, `r Citet(biblio,"oster2019")`, and `r Citet(biblio,"diegert_al2025")` each separately have Stata packages

- `r Citet(biblio,"diegert_al2025")` may also have a Python package

- There's nothing in Julia or R that I am aware of, but I know that `r Citet(biblio,"diegert_al2025")` are planning to develop an R package
