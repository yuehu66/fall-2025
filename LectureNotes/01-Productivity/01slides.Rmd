...
You will practice by doing lots and lots of programming together in class.
...
2. (Optional, but recommened) paid subscription to a generative AI service (e.g. OpenAI, Anthropic, Google, etc.)
...
- Come to class and participate in coding exercises

- Out-of-class review of content and quizzes or other assessments (twice per week)
...
- Out-of-class assessments: 40%


- In-class coding participation / completion / presentation: 25%
...
- You answer questions meant to gauge how well you've learned the out-of-class material

- Please .hi[do not] use AI to assist you
...
- We will work on problem sets together in class (in groups of up to 3)

- Everyone should turn in their own copies of the problem sets
...
All slides will be available on the [course GitHub page](https://github.com/OU-PhD-Econometrics/fall-2025)
...
- There is a [separate slide deck](https://raw.githack.com/OU-PhD-Econometrics/fall-2025/master/LectureNotes/00-JuliaTips/00slides.html#1) for your reference

- This explains more about how to use Julia

- We will gradually learn the contents of that slide deck as we code in-class
...
- After signing up for a GitHub account, go to the class [repository](https://github.com/OU-PhD-Econometrics/fall-2025) and click `Fork` in the top-righthand corner

- Once you do this, you should be able to visit https://github.com/your-username/fall-2025 and see an exact copy of all of the files

- You can also rename your fork if the default name of "fall-2025" is not to your liking
