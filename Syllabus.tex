...
\item Structural Modeling Exercise (15\%)
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Either implement estimation procedures or calibrate parameters and validate through simulation
            ...
            \begin{itemize}
                ...
                \item Simulated data description, parameter values used, and \textit{either} estimaiton validation results \textit{or} theoretical validation of calibrated parameters
                \item Policy experiments with \textbf{simulated counterfactual results} showing quantitative changes in outcomes
